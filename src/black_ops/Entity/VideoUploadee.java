...
public class VideoUploadee {
    ...
    public VideoUploadee(int id_vdeo, String nom_video, String description_video, String url_video, int id_souscat, int id_cl) {
