...
public class LigneComm {
    ...
    public LigneComm(int id, int id_defi, int id_commande, int prix, int quantite) {
        this.id = id;
    ...
    public LigneComm(int id) {
        this.id = id;
    }

    public LigneComm(int id_defi, int id_commande, int quantite) {
        this.id_defi = id_defi;
        this.id_commande = id_commande;
        this.quantite = quantite;
    }
