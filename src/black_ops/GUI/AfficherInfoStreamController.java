...
public class AfficherInfoStreamController implements Initializable {
 ...
 Info_Stream info_stream = null ;
        ...
        colsouscat.setCellValueFactory(new PropertyValueFactory<>("nomsouscat"));
         ...
         datatable();
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource("/black_ops/GUI/AjouterInfoStream.fxml"));
                            try {
                                loader.load();
    ...
    private void ajouterInfoStream(ActionEvent event) {
        ...
        try {
             FXMLLoader loader = new FXMLLoader(getClass().getResource("/black_ops/GUI/AjouterInfoStream.fxml"));
    ...
    private void chercher(KeyEvent event) {
      ...
      if (recherche.isEmpty())
      {
       ...
       colid.setCellValueFactory(new PropertyValueFactory<>("id"));
                colnom.setCellValueFactory(new PropertyValueFactory<>("nom"));
        colimage.setStyle("-fx-alignment: CENTER-LEFT;");
        colimage.setCellValueFactory(new PropertyValueFactory<>("imageV"));
