...
cnx = MaConnexion.getInstance().getCnx();
    ...
    public void updateLigneComm(LigneComm lc, Integer id){
    ...
    public ObservableList<LigneComm> afficherLigneComm (){
        ObservableList<LigneComm> ligneComms = FXCollections.observableArrayList();
